...
// 根据buffid决定覆盖
func coverIDRun(fd *battle5.FuncData, params *battle5.LibFuncParams) (bool, error) {
	// hero := params.Src
...
// 根据buffid决定覆盖
func coverIDInit(fd *battle5.FuncData) error {
	// fd.Vals = nil
...
func regCoverID(mgr *battle5.FuncMgr) {
	mgr.RegFunc("coverid", battle5.FuncLib{
		OnProc: coverIDRun,
		OnInit: coverIDInit,
	})
}
